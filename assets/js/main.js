...
// Auto-close the menu when clicking outside
document.addEventListener('click', function (e) {
  const clickedInsideHeader = header.contains(e.target);
  const clickedToggleButton = headerToggleBtn.contains(e.target);

  if (!clickedInsideHeader && !clickedToggleButton && header.classList.contains('header-show')) {
    headerToggle();
  }
});
